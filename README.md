...
**版本 `0.2.8-eng`**（工程可用：… / wait_until / **wait_real(opt-in)** / chan / **supervise** / Unity Bootstrap / abort·iquit·seq·suspend / Cont 热路径 / sync fast-path·工具；对照 [tabMachine对照](docs/tabMachine对照.md) / [性能与工具](docs/性能与工具.md)；见 [CHANGELOG](CHANGELOG.md) / [工程可用验收](docs/工程可用验收.md)）。
