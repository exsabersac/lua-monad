...
8. [性能与工具](docs/性能与工具.md) — Cont 热路径、bench / flow_doctor / trace / profile；一页速查 [工具速查](docs/工具速查.md)；[`tools/README.md`](tools/README.md)  
